...
const modalBtn8 = document.getElementById("read-more-button-assignment8");
const modalBtn9 = document.getElementById("read-more-button-assignment9");
const modalBtn10 = document.getElementById("read-more-button-assignment10");
const modalBtn11 = document.getElementById("read-more-button-assignment11");
const modalBtn12 = document.getElementById("read-more-button-assignment12");
...
const content12 = document.getElementById("content-12");
...
modalBtn8.addEventListener("click", toggleModal8);
modalBtn9.addEventListener("click", toggleModal9);
modalBtn10.addEventListener("click", toggleModal10);
modalBtn11.addEventListener("click", toggleModal11);
modalBtn12.addEventListener("click", toggleModal12);
